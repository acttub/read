...
// @ts-nocheck
/**
 * Supertonic 브라우저 런타임 — supertone-inc/supertonic 의 web/helper.js 를 그대로 가져왔다.
 * 원본: https://github.com/supertone-inc/supertonic (샘플 코드 MIT)
 * 갱신을 쉽게 하려고 손대지 않는다. 우리 쪽 조정은 engine.ts 에서 한다.
 */
